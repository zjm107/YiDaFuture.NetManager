                ...
                else if (queryParam != null) // 复合条件查询
                {
                    ...
                    foreach (var item in queryParam)
                    {
                        if (!string.IsNullOrEmpty(item.Value.ToString()))
                        {
                            ...
                            {
                                queryParamTemp.Add("lr" + item.Key.Replace("-", "_"), item.Value);
                                querySql += " AND " + compontMap[item.Key].table + "tt." + compontMap[item.Key].field + " = @lr" + item.Key.Replace("-", "_");
                            }
                            ...
                            {
                                queryParamTemp.Add("lr" + item.Key.Replace("-", "_"), "%" + item.Value + "%");
                                querySql += " AND " + compontMap[item.Key].table + "tt." + compontMap[item.Key].field + " like @lr" + item.Key.Replace("-", "_");
                            }
                        }
                    }
                }
