...
namespace YiDaFuture.Application.CRM
{
    ...
    public class CrmInvoiceService : RepositoryFactory
    {
        ...
        public IEnumerable<CrmInvoiceEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                var expression = LinqExtensions.True<CrmInvoiceEntity>();
        ...
        public IEnumerable<CrmInvoiceEntity> GetList(string queryJson)
        {
            try
            {
                return this.BaseRepository().IQueryable<CrmInvoiceEntity>().ToList();
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public CrmInvoiceEntity GetEntity(string keyValue)
        {
            try
            {
                return this.BaseRepository().FindEntity<CrmInvoiceEntity>(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
