...
namespace YiDaFuture.Application.Base.SystemModule
{
    ...
    public interface CodeRuleIBLL
    {
        ...
        /// <returns></returns>
        List<CodeRuleSeedEntity> GetSeedList(string ruleId);
        /// <summary>
        /// 保存单据编号规则种子
        /// </summary>
        /// <param name="keyValue">主键</param>
        /// <param name="codeRuleSeedEntity">种子实体</param>
        void SaveSeed(string keyValue, CodeRuleSeedEntity codeRuleSeedEntity);
        /// <summary>
        /// 获得指定模块或者编号的单据号
        /// </summary>
        /// <param name="enCode">编码</param>
        /// <returns>单据号</returns>
        string GetBillCode(string enCode);
         /// <summary>
        /// 占用单据号
        /// </summary>
        /// <param name="enCode">单据编码</param>
        /// <returns>true/false</returns>
        void UseRuleSeed(string enCode);
        #endregion
    }
}
