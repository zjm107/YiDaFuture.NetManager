...
namespace YiDaFuture.Application.Base.SystemModule
{
    ...
    public class ModuleBLL : ModuleIBLL
    {
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        public bool VirtualDelete(string keyValue)
        {
            try
            {
                ...
                moduleService.VirtualDelete(keyValue);
        ...
        public void SaveEntity(string keyValue, ModuleEntity moduleEntity, List<ModuleButtonEntity> moduleButtonEntitys, List<ModuleColumnEntity> moduleColumnEntitys)
        {
            try
            {
                moduleService.SaveEntity(keyValue, moduleEntity, moduleButtonEntitys, moduleColumnEntitys);
                /*移除缓存信息*/
                cache.Remove(cacheKey, CacheId.module);
