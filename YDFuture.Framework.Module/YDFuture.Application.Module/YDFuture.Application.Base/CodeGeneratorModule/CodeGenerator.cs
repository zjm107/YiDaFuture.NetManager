...
using YiDaFuture.Application.BaseModule.CodeGeneratorModule;
...
namespace YiDaFuture.Application.Base.CodeGeneratorModule
{
    /// <summary>
    ///Ver 2018
    ...
    public class CodeGenerator
    {
        ...
        private string NotesCreate(CodeBaseConfigModel baseConfigModel) {
            ...
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///Ver 2018\r\n");
            sb.Append("    /// Copyright (c) 2019 亿达未来科技发展有限公司\r\n");
        ...
        public string EntityCreate(CodeBaseConfigModel baseConfigModel,string tableName)
        {
            ...
            try
            {
                ...
                sb.Append("using YiDaFuture.Util;\r\n");
        ...
        public string ServiceCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("using YiDaFuture.DataBase.Repository;\r\n");
                sb.Append("using YiDaFuture.Util;\r\n");
                sb.Append("using System;\r\n");
        ...
        public string ControllerCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("namespace YiDaFuture.Application.Web.Areas." + baseConfigModel.area + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
        ...
        public string ControllerCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("namespace YiDaFuture.Application.Web.Areas." + baseInfo.outputArea + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseInfo));
        ...
        public string IndexJSCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("/*");
                sb.Append(" * Ver 8.0(http://www.learun.cn)\r\n");
                sb.Append(" * Copyright (c) 2019 亿达未来科技发展有限公司\r\n");
                ...
                if (queryData.fields.Count > 0)
                {
                    ...
                    foreach (var item in queryData.fields)
                    {
                        ...
                        if (compont.type == "select")
                        {
                            ...
                            {
                                sb.Append("            $('#" + compont.fieldId + "').lrselect({\r\n");
                                ...
                                sb.Append("            $.lrGetDataSource('" + vlist[0] + "', function (data) {\r\n");
                                sb.Append("                $('#" + compont.fieldId + "').lrselectRefresh({\r\n");
