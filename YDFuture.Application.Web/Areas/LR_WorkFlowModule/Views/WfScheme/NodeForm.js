        ...
        if (!!formId) {
            if (type == 0) {
                if (!!formcomponts[formId]) {
                    ...
                    $('#authorize_girdtable').jfGridSet('refreshdata', { rowdatas: authorize });
                }
                else {
                    formcomponts[formId] = [];
                ...
                var _tmpdata = [];
                for (i = 0, l = authorize.length; i < l; i++) {
    ...
    var page = {
        ...
        nodeInit: function () {
            if (currentNode.type != 'conditionnode') {
                ...
                $('#lr_form_tabs li a[data-value="conditionSql"]').parent().remove();
            }
        ...
        bind: function () {
                    ...
                    callBack: function (id) {
                        return top[id].acceptClick(function (data) {
                            ...
                            if (!isRepeat(data.auditorId)) {
                                ...
                                auditors.push(data);
                                $('#auditor_girdtable').jfGridSet('refreshdata', { rowdatas: auditors });
                            }
            ...
            $('#workform_girdtable').jfGrid({
                headData: [
                    ...
                    {
                        label: "表单类型", name: "type", width: 80, align: "center",
                    ...
                    { label: "表单地址", name: "url", width: 400, align: "left" }
                ]
            });
                ...
                learun.layerForm({
                    ...
                    callBack: function (id) {
                        return top[id].acceptClick(function (data) {
                            ...
                            data.id = learun.newGuid();
                            workforms.push(data);
                            $('#workform_girdtable').jfGridSet('refreshdata', { rowdatas: workforms });
                ...
                learun.layerForm({
                    ...
                    callBack: function (id) {
                        return top[id].acceptClick(function (data) {
                            ...
                            $('#condition_girdtable').jfGridSet('refreshdata', { rowdatas: conditions });
                        });
                    }
                });
            });
