        ...
        bind: function () {
            ...
            $('#lr_eye').on('click', function () {
                ...
                if (learun.checkrow(processId)) {
                    learun.frameTab.open({ F_ModuleId: "eye" + processId, F_Icon: 'fa magic', F_FullName: '查看流程进度【' + processName + '】', F_UrlAddress: '/LR_WorkFlowModule/WfMyTask/CustmerWorkFlowForm?tabIframeId=' + "eye" + processId + '&type=100' + "&processId=" + processId });
                }
            });
        },
        initleft: function () {
