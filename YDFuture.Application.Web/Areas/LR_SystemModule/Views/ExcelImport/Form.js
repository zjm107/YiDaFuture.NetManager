                                ...
                                learun.layerForm({
                                    ...
                                    callBack: function (id) {
                                        return top[id].acceptClick(function (data) {
                                            ...
                                            setDes(row, data);
                                            $('#girdtable').jfGridSet('refreshdata', { rowdatas: cols });
                                        });
                                    }
                                });
                            });
                            return '<div style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;background: #fff;" ><span class=\"label label-success \" style=\"cursor: pointer;\">设置</span></div>';
                        }
                    }
                ]
            });
