...
namespace YiDaFuture.Application.Web.Areas.LR_FormModule.Controllers
{
    /// <summary>
    ///Ver 2018
    ...
    public class FormRelationController : MvcControllerBase
    {
        ...
        /// </summary>
        /// <param name="keyValue">主键</param>
        /// <param name="entity">表单与功能信息</param>
        /// <returns></returns>
        [HttpPost]
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, string relationJson, string moduleJson, string moduleColumnJson)
        {
            ...
            moduleIBLL.SaveEntity(formRelationEntity.F_ModuleId, moduleEntity, moduleButtonList, moduleColumnList);
        ...
        public ActionResult DeleteForm(string keyValue)
        {
            ...
            moduleIBLL.VirtualDelete(relation.F_ModuleId);
            return Success("删除成功！");
        }
        #endregion
