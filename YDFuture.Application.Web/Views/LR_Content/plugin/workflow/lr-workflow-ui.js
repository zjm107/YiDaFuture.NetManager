...
(function ($, learun) {
    ...
    $.lrworkflow = {
        render: function ($self) {
            ...
            $self.children(".lr-workflow-work").find('.mCSB_container').append($workArea);
            ...
            var $lineMove = $("<div class='lr-workflow-linemove' style='display:none'></div>");//操作折线时的移动框
        ...
        blurItem: function (dfop) {
            if (dfop.focusId != "") {
                ...
                if ($item.prop("tagName") == "DIV") {
                    ...
                    var $lineMove = $('.lr-workflow-linemove');
